...
import img3 from '@/img/banner/banner-service.jpg';
import img1 from '@/img/banner/banner-moto.jpg';
import img2 from '@/img/banner/banner-cauchos.jpg'
  ...
  <div id="carouselExampleCrossfade" class="relative" data-te-carousel-init data-te-carousel-slide>
    ...
    <div class="relative w-full overflow-hidden after:clear-both after:block after:content-['']">
      ...
      <div
        v-for="item in items"
        :key="item.id"
        class="relative float-left -mr-[100%] w-full max-h-[350px] !transform-none opacity-0 transition-opacity duration-[600ms] ease-in-out motion-reduce:transition-none"
        data-te-carousel-fade
        data-te-carousel-item
      >
